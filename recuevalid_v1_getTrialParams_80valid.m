function [deg_matrix,deg_matrix_label] = recuevalid_v1_getTrialParams_80valid
% 26 June, 2023
% retrocue-validity-80% valid cue
% 250 trials in total

% set trial number
trial_Num = 250; 
tNumRcueV = 0.8*trial_Num; % retrocue-valid
tNumRcueINV = 0.2*trial_Num; % retrocue-invalid
