function [respDeg,respRT,respStartRT]=recuevalid_v1_ColorGratingTest_respStart(test_degree,test_color,param,scr,Eyetracking,EEGrecording,SerialPortObj)
...
% get the first time point when move the mouse
while 1
    [m,n,~]=GetMouse(scr.wptr);
